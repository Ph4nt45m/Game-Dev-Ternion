...
public:
	...
	void DrawSprite(Sprite& sprite, bool horizontalFlip, bool verticalFlip);

	AnimatedSprite* CreateAnimatedSprite(const char* pcFilename);
	void DrawAnimatedSprite(AnimatedSprite& sprite, int frame, bool horizontalFlip, bool verticalFlip);
