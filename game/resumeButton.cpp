...
ResumeButton::ResumeButton(float x, float y)
    : Button(x, y),
...
bool ResumeButton::Initialise(Renderer& renderer)
{
    // Load the button sprites
    m_buttonSpriteNormal = renderer.CreateSprite("..\\Sprites\\Menus\\Buttons\\resumeNormal.png");
    m_buttonSpriteHovered = renderer.CreateSprite("..\\Sprites\\Menus\\Buttons\\resumeHovered.png");
    m_buttonSpritePressed = renderer.CreateSprite("..\\Sprites\\Menus\\Buttons\\resumePressed.png");
...
void ResumeButton::Update(float deltaTime, InputSystem& inputSystem)
{
...
void ResumeButton::Draw(Renderer& renderer)
{
    if (m_isHeld)
    {
