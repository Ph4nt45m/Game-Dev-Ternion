...
void
Renderer::DrawSprite(Sprite& sprite, bool horizontalFlip, bool verticalFlip)
{
	m_pSpriteShader->SetActive(); 
...
void
Renderer::DrawAnimatedSprite(AnimatedSprite& sprite, int frame, bool horizontalFlip, bool verticalFlip)
{
	m_pSpriteShader->SetActive();
