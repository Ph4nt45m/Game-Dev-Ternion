...
bool RestartButton::Initialise(Renderer& renderer)
{
    // Load the button sprites
    m_buttonSpriteNormal = renderer.CreateSprite("..\\Sprites\\Menus\\Buttons\\restartNormal.png");
    m_buttonSpriteHovered = renderer.CreateSprite("..\\Sprites\\Menus\\Buttons\\restartHovered.png");
    m_buttonSpritePressed = renderer.CreateSprite("..\\Sprites\\Menus\\Buttons\\restartPressed.png");
...
void RestartButton::Update(float deltaTime, InputSystem& inputSystem)
{
...
void RestartButton::Draw(Renderer& renderer)
{
    if (m_isHeld)
    {
