...
InputSystem::Initialise()
{
	...
	ShowMouseCursor(true); // Toggle mouse cursor visibility
...
InputSystem::ProcessInput()
{
	...
	for (int k = 0; k < SDL_NUM_SCANCODES; ++k)
	{
		m_pPreviousKeyboardState[k] = m_pCurrentKeyboardState[k];
	}
