...
IncreaseButton::IncreaseButton(float x, float y)
    : Button(x, y),
...
void IncreaseButton::Update(float deltaTime, InputSystem& inputSystem)
{
...
void IncreaseButton::Draw(Renderer& renderer)
{
    m_buttonSpriteNormal->Draw(renderer, false, false);
}

void IncreaseButton::soundVolume()
{
