...
CreditsButton::CreditsButton(float x, float y)
    : Button(x, y),
...
bool CreditsButton::Initialise(Renderer& renderer)
{
    // Load the button sprites
    m_buttonSpriteNormal = renderer.CreateSprite("..\\Sprites\\Menus\\Buttons\\CreditsNormal.png");
    m_buttonSpriteHovered = renderer.CreateSprite("..\\Sprites\\Menus\\Buttons\\CreditsHovered.png");
    m_buttonSpritePressed = renderer.CreateSprite("..\\Sprites\\Menus\\Buttons\\CreditsPressed.png");
...
void CreditsButton::Update(float deltaTime, InputSystem& inputSystem)
{
...
void CreditsButton::Draw(Renderer& renderer)
{
    if (m_isHeld)
    {
