...
void
Sprite::Draw(Renderer& renderer, bool horizontalFlip, bool verticalFlip)
{
	m_pTexture->SetActive(); 
	renderer.DrawSprite(*this, horizontalFlip, verticalFlip);
}
...
void
Sprite::SetCursorBorder(Vector2* cursor, Sprite* cursorSprite)
{
	SetX((int)cursor->GetX() + (cursorSprite->GetWidth() / 2) + 1);
	SetY((int)cursor->GetY() + (cursorSprite->GetHeight() / 2) + 2);
	SetRedTint(0.0f);
	SetGreenTint(0.0f);
	SetBlueTint(0.0f);
	SetAngle(-90.0f);
...
void
Sprite::SetCursorBody(Vector2* cursor, Sprite* cursorSprite)
{
	SetScale(0.2f);
	SetX((int)cursor->GetX() + (cursorSprite->GetWidth() / 2) + 5);
	SetY((int)cursor->GetY() + (cursorSprite->GetHeight() / 2) + 5);
	SetRedTint(1.0f);
	SetGreenTint(0.0f);
	SetBlueTint(0.0f);
	SetAngle(-90.0f);
